// Fixed navigation component for all pages - with error handling
function createNavigation() {
    try {
        ...
        // Navigation HTML with fallbacks for missing images
        const navHTML = `
            ...
            ">
                <div style="
                    ...
                    padding: 0 20px;
                ">
                    <!-- Logo on the left - with text fallback -->
                    ...
                    ">
                        <a href="index.html" class="nav-link ${currentPage === 'index.html' ? 'active' : ''}" style="
                    ...
                    <div style="display: flex; align-items: center; gap: 20px;">
                        ...
                        <!-- Powered by ScaleTeam6 - text only -->
                        <div style="
                            margin-left: 30px;
                            display: flex;
                            align-items: center;
        ...
        document.body.insertAdjacentHTML('afterbegin', '<div style="height: 120px;"></div>');
    }
}
...
// Initialize navigation when DOM is ready with error handling
try {
