// SYSTEMIC FIX: Correct template mapping for all 96 subcomponents
// Ensures each subcomponent shows ONLY its own templates
...
(function() {
    ...
    // Override the enhanceResourcesTab function to use correct templates
    window.enhanceResourcesTab = function() {
        const resourcesContent = document.getElementById('resource-templates') || 
                                document.getElementById('resources-content') ||
                                document.querySelector('#resources-tab .templates-list');
        ...
        const templates = TEMPLATE_MAPPING[subcomponentId] || ["Generic Template 1", "Generic Template 2", "Generic Template 3"];
        
        // Create the templates display
        const templatesHTML = `
        ...
        resourcesContent.innerHTML = templatesHTML;
    };
    ...
    // Override tab switching to refresh resources when switching to resources tab
    ...
    if (originalSwitchTab) {
        window.switchTab = function(tabName, event) {
            ...
            // If switching to resources tab, load correct templates
