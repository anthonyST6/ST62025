...
// Script to add missing subcomponents and ensure all titles match content
const fs = require('fs');
const path = require('path');

// Read the current educational content
const contentPath = path.join(__dirname, 'educational-content.js');
let content = fs.readFileSync(contentPath, 'utf8');

// Missing subcomponents to add
const missingSubcomponents = {
  ...
  "3-4": {
    ...
    templates: [
      ...
      "Not-Doing List Template",
      "Trade-off Decision Matrix"
    ],
    metrics: [
      "Focus score (% resources on core)",
    ...
    workspace: {
      tools: [
        "Strategy Tools (Cascade, Perdoo)",
        "Decision Tracking (Coda, Notion)",
        "Portfolio Management (Planview, Clarity)",
        "OKR Platforms (Weekdone, Ally.io)"
      ],
      templates: [
        "Strategic Focus Canvas",
        "Not-Doing List Template",
      ...
      bestPractices: [
        ...
        "Resist feature creep from big deals"
      ]
    }
  },
  ...
  "3-5": {
    ...
    workspace: {
      tools: [
        "Experiment Tracking (Optimizely, LaunchDarkly)",
  ...
  "3-6": {
    ...
    metrics: [
      ...
      "Learning extraction frequency"
    ],
    workspace: {
      tools: [
        "Documentation (Notion, Confluence)",
        "Decision Tools (Cloverpop, Loomio)",
        "Knowledge Management (Guru, Slab)",
      ...
      bestPractices: [
        "Document decisions within 48 hours",
  ...
  // Block 5: Early Adopter Wins (missing 5-3 through 5-6)
  "5-3": {
    ...
    workspace: {
      tools: [
        ...
        "Customer Intelligence (Gong, Chorus)",
  ...
  "5-4": {
    ...
    metrics: [
      "Testimonials collected monthly",
    ...
    workspace: {
      tools: [
        "Video Platforms (Vidyard, Loom)",
        "Review Management (G2, Capterra)",
        "Social Proof (Testimonial.to, Boast)",
  ...
  "5-5": {
    ...
    templates: [
      ...
      "Win Definition Canvas",
      "Achievement Tracker"
    ],
    metrics: [
      "Criteria achievement rate",
      "Time to success",
      "Success correlation with retention",
    ...
    workspace: {
      tools: [
        ...
        "Goal Tracking (Weekdone, 15Five)",
        "Reporting (Databox, Geckoboard)"
      ],
      templates: [
        "Success Criteria Matrix",
        "Win Definition Canvas",
      ...
      bestPractices: [
        "Define success upfront with customer",
  ...
  "5-6": {
    ...
    workspace: {
      tools: [
        "Win/Loss Analysis (Clozd, DoubleCheck)",
        "Call Recording (Gong, Chorus)",
        "CRM Systems (Salesforce, HubSpot)",
        "Knowledge Sharing (Guru, Confluence)"
      ],
      templates: [
        "Deal Debrief Form",
        "Win/Loss Interview Guide",
      ...
      bestPractices: [
        "Debrief every deal over threshold",
        "Include product and marketing",
        "Interview lost prospects when possible",
  ...
  "6-4": {
    ...
    workspace: {
      tools: [
        "Onboarding Tools (Userpilot, Appcues)",
        "Email Automation (Customer.io, Braze)",
  ...
  "6-5": {
    ...
    workspace: {
      tools: [
        ...
        "Feedback Management (Canny, UserVoice)",
        "NPS Platforms (AskNicely, Promoter.io)",
  ...
  "6-6": {
    ...
    metrics: [
      "Power user identification rate",
      "Engagement score",
      "Referral generation",
    ...
    workspace: {
      tools: [
        ...
        "Gamification (Bunchball, Influitive)",
        "Event Management (Hopin, Airmeet)",
        "Advocacy Tools (ReferralCandy, Post Affiliate Pro)"
      ],
      templates: [
        "Power User Criteria",
        "Benefits Framework",
  ...
  // Block 13: Market Domination (missing 13-3 through 13-6)
  "13-3": {
    ...
    workspace: {
      tools: [
        ...
        "Partner Portals (Crossbeam, Allbound)",
        "Developer Relations (DevRel tools)",
      ...
      bestPractices: [
        "Start with strategic integrations",
  ...
  "13-4": {
    ...
    workspace: {
      tools: [
        ...
        "Web Monitoring (Google Alerts, Mention)",
  ...
  "13-5": {
    ...
    workspace: {
      tools: [
        ...
        "PR Platforms (Cision, Muck Rack)",
        "Social Media (Hootsuite, Buffer)",
        "Webinar Tools (ON24, BigMarker)"
      ],
      templates: [
        "Thought Leadership Plan",
        "Content Calendar Template",
  ...
  "13-6": {
    ...
    workspace: {
      ...
      bestPractices: [
        "Lock in customers with value",
        "Monitor competitors closely",
        "Respond quickly but strategically",
  ...
  "14-3": {
    ...
    workspace: {
      tools: [
        ...
        "Dashboard Tools (Databox, Geckoboard)",
        "Analytics (Google Analytics, Mixpanel)"
      ],
      templates: [
        "Dashboard Design Canvas",
  ...
  "14-4": {
    ...
    workspace: {
      tools: [
        "SaaS Management (Blissfully, Zylo)",
        "Integration Platforms (Zapier, Workato)",
        "IT Asset Management (ServiceNow, Freshservice)",
        "Spend Management (Vendr, Negotiatus)"
      ],
      templates: [
        "Tool Audit Spreadsheet",
        "ROI Calculator",
  ...
  "14-5": {
    ...
    metrics: [
      ...
      "Revenue per operation FTE"
    ],
    workspace: {
      tools: [
        "RevOps Platforms (Clari, Gong)",
        "Process Documentation (Lucidchart, Miro)",
        "Workflow Automation (Workato, Tray.io)",
        "CRM Systems (Salesforce, HubSpot)"
      ],
      templates: [
        "Process Documentation Template",
  ...
  "14-6": {
    ...
    metrics: [
      ...
      "Customer satisfaction with SLA"
    ],
    workspace: {
      tools: [
        ...
        "Reporting Platforms (Statuspage, StatusCast)"
      ],
      templates: [
        "SLA Template",
        "Performance Report Format",
      ...
      bestPractices: [
        "Make SLAs realistic and measurable",
...
// Add workspace for 10-1 (Sales Hiring Profile)
const workspace10_1 = {
  workspace: {
    tools: [
      "ATS Systems (Greenhouse, Lever)",
      "Assessment Tools (Predictive Index, SalesGenomix)",
      "Reference Check (Checkster, SkillSurvey)",
      "Recruiting Platforms (LinkedIn Recruiter, AngelList)"
    ],
    templates: [
    ...
    bestPractices: [
      "Define ideal profile before searching",
      "Use structured interviews",
      "Check references thoroughly",
      "Test selling skills practically"
    ]
  }
};

// Add workspace for 10-2 (Discovery Call Framework)
const workspace10_2 = {
  workspace: {
    tools: [
      "Call Recording (Gong, Chorus)",
      "Sales Enablement (Showpad, Seismic)",
      "CRM Systems (Salesforce, HubSpot)",
      "Call